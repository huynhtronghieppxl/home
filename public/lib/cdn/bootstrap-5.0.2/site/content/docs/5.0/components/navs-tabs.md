...
<nav class="nav nav-pills flex-column flex-sm-row">
  <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="javascript:void(0)">Active</a>
  <a class="flex-sm-fill text-sm-center nav-link" href="javascript:void(0)">Longer nav link</a>
  <a class="flex-sm-fill text-sm-center nav-link" href="javascript:void(0)">Link</a>
  <a class="flex-sm-fill text-sm-center nav-link disabled" href="javascript:void(0)" tabindex="-1" aria-disabled="true">Disabled</a>
</nav>
{{< /example >}}
