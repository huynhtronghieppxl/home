...
{{< example >}}
<p class="text-muted">
  Muted text with a <a href="javascript:void(0)" class="text-reset">reset link</a>.
</p>
{{< /example >}}
...
<a href="javascript:void(0)" class="text-decoration-none">This link has its text decoration removed</a>
{{< /example >}}
