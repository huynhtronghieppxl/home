...
describe('Tooltip', () => {
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" id="tooltipEl" rel="tooltip" title="Nice and short title">'
    ...
    it('should not take care of disallowed data attributes', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" data-bs-sanitize="false" title="Another tooltip">'
    ...
    it('should convert title and content to string if numbers', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip">'
    ...
    it('should enable selector delegation', done => {
      ...
      containerEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip">'
    ...
    it('should create offset modifier when offset is passed as a function', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Offset from function">'
    ...
    it('should create offset modifier when offset option is passed in data attribute', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" data-bs-offset="10,20" title="Another tooltip">'
  ...
  describe('enable', () => {
    it('should enable a tooltip', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip">'
  ...
  describe('show', () => {
    ...
    it('should show a tooltip when hovering a children element', done => {
      fixtureEl.innerHTML =
        '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip">' +
    ...
    it('should throw an error the element is not visible', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" style="display: none" rel="tooltip" title="Another tooltip">'
    ...
    it('should properly maintain tooltip state if leave event occurs and enter event occurs during hide transition', done => {
      ...
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip" data-bs-placement="top" style="position:fixed;left:50%;top:50%;">Trigger</a>'
    ...
    it('should show a tooltip with custom class provided in data attributes', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip" data-bs-custom-class="custom-class">'
  ...
  describe('isWithContent', () => {
    ...
    it('should return false if there is no content', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="">'
  ...
  describe('getTitle', () => {
    ...
    it('should call title function', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip"></a>'
  ...
  describe('aria-label', () => {
    it('should add the aria-label attribute for referencing original title', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip"></a>'
    ...
    it('should not add the aria-label attribute if the attribute already exists', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" aria-label="Different label" title="Another tooltip"></a>'
    ...
    it('should not add the aria-label attribute if the element has text content', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" rel="tooltip" title="Another tooltip">text content</a>'
