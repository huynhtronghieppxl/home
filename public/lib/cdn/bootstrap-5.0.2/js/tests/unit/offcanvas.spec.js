...
describe('Offcanvas', () => {
  ...
  describe('constructor', () => {
    it('should call hide when a element with data-bs-dismiss="offcanvas" is clicked', () => {
      fixtureEl.innerHTML = [
        '<div class="offcanvas">',
        '  <a href="javascript:void(0)" data-bs-dismiss="offcanvas">Close</a>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    ...
    it('should not call toggle on disabled elements', () => {
      fixtureEl.innerHTML = [
        '<a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#offcanvasdiv1" class="disabled"></a>',
        '<div id="offcanvasdiv1" class="offcanvas"></div>'
      ].join('')
