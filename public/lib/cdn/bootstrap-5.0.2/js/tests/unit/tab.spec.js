  ...
  describe('data-api', () => {
    ...
    it('selected tab should deactivate previous selected link in dropdown', () => {
      fixtureEl.innerHTML = [
        ...
        '    <a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" href="javascript:void(0)">Dropdown</a>',
    ...
    it('selecting a dropdown tab does not activate another', () => {
      const nav1 = [
        ...
        '  <li class="nav-item dropdown">',
        '    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0)">Dropdown</a>',
        '    <div class="dropdown-menu">',
