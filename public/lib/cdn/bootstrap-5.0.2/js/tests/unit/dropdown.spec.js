  ...
  describe('constructor', () => {
    ...
    it('should add a listener on trigger which do not have data-bs-toggle="dropdown"', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="javascript:void(0)">Secondary link</a>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('hide', () => {
    ...
    it('should remove event listener on touch-enabled device that was added in show method', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="javascript:void(0)">Dropdwon item</a>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    ...
    it('should skip disabled element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '    <a id="item1" class="dropdown-item" href="javascript:void(0)">Another link</a>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should focus next/previous element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown-menu">',
        '    <a id="item1" class="dropdown-item" href="javascript:void(0)">A link</a>',
        '    <a id="item2" class="dropdown-item" href="javascript:void(0)">Another link</a>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should propagate escape key events if dropdown is closed', done => {
      fixtureEl.innerHTML = [
        ...
        '    <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
        '    <div class="dropdown-menu">',
        '      <a class="dropdown-item" href="javascript:void(0)">Some Item</a>',
        '   </div>',
        '  </div>',
        '</div>'
      ]
    ...
    it('should close dropdown (only) by clicking inside the dropdown menu when it has data-attribute `data-bs-auto-close="inside"`', done => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="javascript:void(0)">Dropdown item</a>',
        ' </div>',
        '</div>'
      ]
