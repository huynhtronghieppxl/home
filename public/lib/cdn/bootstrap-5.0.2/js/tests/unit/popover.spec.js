...
describe('Popover', () => {
  ...
  describe('show', () => {
    it('should show a popover', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" title="Popover" data-bs-content="https://twitter.com/getbootstrap">BS twitter</a>'
    ...
    it('should set title and content from functions', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)">BS twitter</a>'
    ...
    it('should show a popover with just content without having header', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)">Nice link</a>'
    ...
    it('should show a popover with provided custom class', done => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" title="Popover" data-bs-content="https://twitter.com/getbootstrap" data-bs-custom-class="custom-class">BS twitter</a>'
  ...
  describe('jQueryInterface', () => {
    ...
    it('should create a popover with a config object', () => {
      fixtureEl.innerHTML = '<a href="javascript:void(0)" title="Popover">BS twitter</a>'
