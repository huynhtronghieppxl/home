...
describe('Collapse', () => {
  ...
  describe('constructor', () => {
    ...
    it('should allow jquery object in parent config', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a data-bs-toggle="collapse" href="javascript:void(0)">Toggle item</a>',
  ...
  describe('toggle', () => {
    ...
    it('should find collapse children if they have collapse class too not only data-bs-parent', done => {
      fixtureEl.innerHTML = [
        '<div class="my-collapse">',
        '  <div class="item">',
        '    <a data-bs-toggle="collapse" href="javascript:void(0)">Toggle item 1</a>',
        '    <div id="collapse1" class="collapse show">Lorem ipsum 1</div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="triggerCollapse2" data-bs-toggle="collapse" href="javascript:void(0)">Toggle item 2</a>',
  ...
  describe('data-api', () => {
    ...
    it('should remove "collapsed" class from target when collapse is shown', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="button" data-bs-toggle="collapse" class="collapsed" href="javascript:void(0)" data-bs-target="#test1"></a>',
        '<a id="link2" role="button" data-bs-toggle="collapse" class="collapsed" href="javascript:void(0)" data-bs-target="#test1"></a>',
        '<div id="test1"></div>'
      ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="button" data-bs-toggle="collapse" href="javascript:void(0)" data-bs-target="#test1"></a>',
        '<a id="link2" role="button" data-bs-toggle="collapse" href="javascript:void(0)" data-bs-target="#test1"></a>',
    ...
    it('should allow accordion to target multiple elements', done => {
      fixtureEl.innerHTML = [
        '<div id="accordion">',
        '  <a id="linkTriggerOne" data-bs-toggle="collapse" data-bs-target=".collapseOne" href="javascript:void(0)" aria-expanded="false" aria-controls="collapseOne"></a>',
        '  <a id="linkTriggerTwo" data-bs-toggle="collapse" data-bs-target=".collapseTwo" href="javascript:void(0)" aria-expanded="false" aria-controls="collapseTwo"></a>',
