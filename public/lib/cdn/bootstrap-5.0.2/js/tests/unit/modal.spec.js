...
describe('Modal', () => {
  ...
  describe('data-api', () => {
    ...
    it('should prevent default when the trigger is <a> or <area>', done => {
      fixtureEl.innerHTML = [
        '<a data-bs-toggle="modal" href="javascript:void(0)" data-bs-target="#exampleModal"></a>',
        '<div id="exampleModal" class="modal"><div class="modal-dialog"></div></div>'
      ].join('')
    ...
    it('should not focus the trigger if the modal is not visible', done => {
      fixtureEl.innerHTML = [
        '<a data-bs-toggle="modal" href="javascript:void(0)" data-bs-target="#exampleModal" style="display: none;"></a>',
