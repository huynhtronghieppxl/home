...
$(document).ready(function () {
    ...
    $(function () {
        ...
        $('#reportrange').daterangepicker({
            ...
            "drops": "up",
            ranges: {
                // 'Hôm nay': [moment().format('DD/MM/YYYY'), moment().format('DD/MM/YYYY')],
                // 'Hôm qua': [moment().subtract(1, 'days').format('DD/MM/YYYY'), moment().subtract(1, 'days').format('DD/MM/YYYY')],
                // 'Tuần này': [moment().subtract(6, 'days'), moment().format('DD/MM/YYYY')],
                // 'Tuần trước': [moment().subtract(6, 'days'), moment()],
                // 'Tháng này': [moment().subtract(29, 'days'), moment()],
                // 'Tháng trước': [moment().subtract(29, 'days'), moment()],
                // '3 tháng gần nhất': [moment().subtract(1, 'month').startOf('month'), moment().endOf('month')],
                // 'Năm nay': [moment().startOf('year'), moment().endOf('year')],
                // 'Năm trước': [moment().subtract(1, 'year').startOf('year'), moment().subtract(1, 'year').endOf('year')],
                // '3 năm gần nhất': [moment().subtract(2, 'year').startOf('year'), moment().endOf('year')],
                // 'Tất cả năm': [moment().startOf('month'), moment().endOf('month')],
                'Hôm nay': ['a'],
                'Hôm qua': [],
                'Tuần này': [],
                'Tuần trước': [],
                'Tuỳ chọn': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
            }
        }, cb);
